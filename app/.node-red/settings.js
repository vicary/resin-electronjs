...
while (!camera) {
  try {
    ...
    console.error(`Unable to open camera: [${code}] ${message}`);
  }
}
...
module.exports = {
  ...
  editorTheme: {
    page: {
      title: "Admin Panel",
      favicon: "/usr/src/app/.node-red/assets/favicon.ico"
    },
    header: {
      title: "Photobox"
    },
    ...
    login: {
      image: "/usr/src/app/.node-red/assets/resin_logo.png" // a 256x256 image
    }
  },
