        ...
        me.$$init = function (cfg) {
            ...
            me.$$ws.onmessage = function (message) {
                try {
                    ...
                    me.$$fireEvent(decoded.topic, decoded.payload);
            ...
            if (messageQueue.length > 0) {
                ...
                switch (msgObj.topic) {
                    ...
                    default:
                        ...
                        if (typeof fixtures[msgObj.topic] !== 'undefined') {
                            msgObj.payload = fixtures[msgObj.topic].payload || msgObj.payload;
                            msgObj.topic = fixtures[msgObj.topic].topic || msgObj.topic;
                        }
